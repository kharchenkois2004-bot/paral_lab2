...
int main() {
    ...
    const char *imageName = images[0];              // Имя изображения
    ...
    // Переменные
    int threadCount = 9;                            // Кол-во потоков
    ...
    // Старт таймера для подсчета времени исполнения
    ...
    // Финиш таймера для подсчета времени исполнения
